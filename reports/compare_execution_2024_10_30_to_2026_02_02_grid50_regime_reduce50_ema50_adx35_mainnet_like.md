...
- Raw CSV: `logs/compare_execution_2024_10_30_to_2026_02_02_grid50_regime_reduce50_ema50_adx35_mainnet_like.csv`

| Model | Net PnL | ROI | Annual ROI | Max DD | Trades | Win % | Rejected | Partial | Cancel race | Dust | Slip cost | Vs naive | Target >= min |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|:---:|
| naive | 4,563.33 | 15.21% | 12.07% | 13.82% | 432 | 100.00% | 0 | 0 | 0 | 0 | 0.0000 | +0.00% | yes |
| realistic_0.3s | 4,256.98 | 14.19% | 11.26% | 14.45% | 452 | 100.00% | 0 | 93 | 0 | 0 | 112.9804 | -1.02% | no |
